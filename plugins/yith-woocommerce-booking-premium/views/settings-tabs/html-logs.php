...
?>
<div id="yith-wcbk-logs">
    <div id="yith-wcbk-settings-tab-title-wrapper">
        <h2 id="yith-wcbk-settings-tab-title"><?php _ex( 'Logs', 'Settings tab title', 'yith-booking-for-woocommerce' ); ?></h2>
        <div id="yith-wcbk-logs-page-actions">
            <a class="yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--trash" href="<?php echo $delete_log_url ?>"><?php _e( 'Delete Logs', 'yith-booking-for-woocommerce' ) ?></a>
        </div>
    </div>
    <div class="clear"></div>
        ...
        <div id="yith-wcbk-logs-tab-actions" class="clearfix">
            ...
            <div class="alignleft actions">
                <form method="post">
                    ...
                    <input type="submit" class="button" value="<?php _e( 'Filter', 'yith-booking-for-woocommerce' ) ?>">
                </form>
            </div>
