    ...
    <div class="yith-wcbk-settings-section-box__content">
        ...
        <div class="yith-wcbk-settings-section-box__content__actions yith-wcbk-right">
            <?php if ( !empty( $add_button ) ): ?>
                <span class="yith-wcbk-admin-button yith-wcbk-admin-button--primary yith-wcbk-admin-button--check yith-wcbk-availability-rules__add-rule"><?php _e( 'Add rule', 'yith-booking-for-woocommerce' ) ?></span>
            <?php endif; ?>
            <span class="yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--trash yith-wcbk-availability-rules__delete-rule"><?php _e( 'Delete rule', 'yith-booking-for-woocommerce' ) ?></span>
        </div>
    </div>
</div>