...
<div class="yith-wcbk-settings-section-box yith-wcbk-price-rule <?php echo $default_toggle_class ?>" data-index="<?php echo $index ?>">
    ...
    <div class="yith-wcbk-settings-section-box__content">
        ...
        $conditions_actions_html = "<div class='yith-wcbk-settings-section__content__actions'>
        <span class='yith-wcbk-admin-button yith-wcbk-admin-button--small yith-wcbk-admin-button--plus yith-wcbk-price-rule__conditions__new-condition'>" .
        ...
        <div class="yith-wcbk-settings-section-box__content__actions yith-wcbk-right">
            <?php if ( !empty( $add_button ) ): ?>
                <span class="yith-wcbk-admin-button yith-wcbk-admin-button--primary yith-wcbk-admin-button--check yith-wcbk-price-rules__add-rule"><?php _e( 'Add rule', 'yith-booking-for-woocommerce' ) ?></span>
            <?php endif; ?>
            <span class="yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--trash yith-wcbk-price-rules__delete-rule"><?php _e( 'Delete rule', 'yith-booking-for-woocommerce' ) ?></span>
        </div>
    </div>
</div>