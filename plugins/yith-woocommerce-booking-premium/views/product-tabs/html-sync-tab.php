    ...
    <div class="yith-wcbk-settings-section">
        ...
        <div class="yith-wcbk-settings-section__content">
            ...
            $export_future_ics_html  = "<input type='hidden' name='_yith_booking_external_calendars_key' value='{$key}'/>
                ...
                <span class='yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--copy yith-wcbk-copy-to-clipboard' data-selector-to-copy='#{$export_future_ics_id}'>{$copy_to_clipboard_label}</span>
                <a href='{$export_future_ics_url}' class='yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-admin-button--download'>{$download_label}</a>";
