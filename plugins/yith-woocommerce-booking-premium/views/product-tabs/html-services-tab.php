...
<div class="yith-wcbk-product-metabox-options-panel options_group show_if_<?php echo $prod_type; ?>">
    <div class="yith-wcbk-settings-section">
        ...
        <div class="yith-wcbk-settings-section__content yith-wcbk-services__list">
            ...
            $service_field_html .= "<span class='yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-select2-select-all' data-select-id='_yith_wcbk_booking_services'>" . __( 'Select all', 'yith-booking-for-woocommerce' ) . "</span>";
            $service_field_html .= "<span class='yith-wcbk-admin-button yith-wcbk-admin-button--secondary yith-wcbk-select2-deselect-all' data-select-id='_yith_wcbk_booking_services'>" . __( 'Deselect all', 'yith-booking-for-woocommerce' ) . "</span>";
            ...
            <div class="yith-wcbk-settings-section__content__actions">
                <?php if ( current_user_can( 'manage_' . YITH_WCBK_Post_Types::$service_tax . 's' ) ): ?>
                    <span id="yith-wcbk-services__create-btn" class="yith-wcbk-admin-button yith-wcbk-admin-button--plus"><?php _e( 'Create new service', 'yith-booking-for-woocommerce' ) ?></span>
                    ...
                    <div id="yith-wcbk-services__create" class="yith-wcbk-settings-section-box yith-wcbk-settings-section-box--no-toggle">
                        ...
                        <div class="yith-wcbk-settings-section-box__content">
                            ...
                            <div class="yith-wcbk-settings-section-box__content__actions yith-wcbk-right">
                                <span class="yith-wcbk-admin-button yith-wcbk-admin-button--check yith-wcbk-services__create-submit"><?php _e( 'Create', 'yith-booking-for-woocommerce' ) ?></span>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
