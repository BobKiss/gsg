...
if ( !class_exists( 'YITH_WCBK_Product_Extra_Cost' ) ) {
    ...
    class YITH_WCBK_Product_Extra_Cost extends YITH_WCBK_Simple_Object {
        ...
        public function get_identifier() {
            return $this->is_custom() ? '_' . $this->get_slug() : $this->get_id();
        }
        ...
        public function get_slug() {
            return $this->is_custom() ? sanitize_title( $this->get_name() ) : get_post_field( 'post_name', $this->get_id() );
        }
...
if ( !function_exists( 'yith_wcbk_product_extra_cost' ) ) {
    function yith_wcbk_product_extra_cost( $args ) {
        return $args instanceof YITH_WCBK_Product_Extra_Cost ? $args : new YITH_WCBK_Product_Extra_Cost( $args );
    }
}