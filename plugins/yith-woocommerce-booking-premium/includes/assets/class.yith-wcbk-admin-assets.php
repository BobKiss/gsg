...
if ( !class_exists( 'YITH_WCBK_Admin_Assets' ) ) {
    ...
    class YITH_WCBK_Admin_Assets {
        ...
        public function register_styles() {
            wp_register_style( 'yith-wcbk-admin-fields', YITH_WCBK_ASSETS_URL . '/css/admin/admin-fields.css', array(), YITH_WCBK_VERSION );
            ...
            wp_register_style( 'yith-wcbk-admin-plugin-fw-panel', YITH_WCBK_ASSETS_URL . '/css/admin/admin-plugin-fw-panel.css', array(), YITH_WCBK_VERSION );
        }
        ...
        public function register_scripts() {
            ...
            wp_register_script( 'yith-wcbk-admin-plugin-fw-panel', YITH_WCBK_ASSETS_URL . '/js/admin/admin-plugin-fw-panel' . $suffix . '.js', array( 'jquery' ), YITH_WCBK_VERSION, true );
        ...
        public function enqueue() {
            ...
            // Settings
            if ( $this->is( 'settings' ) ) {
                wp_enqueue_style( 'yith-wcbk-admin-plugin-fw-panel' );
                wp_enqueue_script( 'yith-wcbk-admin-plugin-fw-panel' );
            }
