...
<tr data-id="<?php echo (isset($availability['id'])) ? $availability['id'] : '' ?>">
	...
	<td>
		<div class="from_date inventory-form-to-input">
			<input type="text" style="border: 1px solid #ddd;" class="rnb-date-picker" name="redq_availability_pickup_datetime[]" value="<?php if (!empty($availability['pickup_datetime'])) echo $availability['pickup_datetime']; ?>" autocomplete="off" />
		</div>
	</td>
	<td>
		<div class="to_date inventory-form-to-input">
			<input type="text" style="border: 1px solid #ddd;" class="rnb-date-picker" name="redq_availability_dropoff_datetime[]" value="<?php if (!empty($availability['return_datetime'])) echo $availability['return_datetime']; ?>" autocomplete="off" />
		</div>
	</td>
	<td class="inventory-remove">
		<div class="select">
			<input type="hidden" name="redq_availability_row_id[]" value="<?php echo (isset($availability['id'])) ? $availability['id'] : '' ?>">
		</div>
