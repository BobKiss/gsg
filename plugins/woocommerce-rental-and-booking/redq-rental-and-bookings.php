    ...
    class RedQ_Rental_And_Bookings
    {
        ...
        public function rnb_init_custom_db_table()
        {
            ...
            $schema = "CREATE TABLE {$wpdb->prefix}rnb_availability (
                ...
                product_id bigint(200) NULL,
                inventory_id bigint(200) NULL,
                order_id bigint(200) NULL,
                item_id bigint(200) NULL,
                ...
                inventory bigint(200) unsigned NOT NULL,
                product bigint(200) unsigned NOT NULL,
								KEY inventory (inventory),
								KEY product (product),
								CONSTRAINT {$wpdb->prefix}rnb_inventory_product_ibfk_1 FOREIGN KEY (inventory) REFERENCES {$wpdb->posts} (ID) ON DELETE CASCADE,
								CONSTRAINT {$wpdb->prefix}rnb_inventory_product_ibfk_2 FOREIGN KEY (product) REFERENCES {$wpdb->posts} (ID) ON DELETE CASCADE
            ) $charset_collate;";
        ...
        {
            $links[] = '<a href="https://redq.gitbooks.io/woocommerce-rental-and-booking/content/" target="_blank">' . __('Docs', 'redq-rental') . '</a>';
