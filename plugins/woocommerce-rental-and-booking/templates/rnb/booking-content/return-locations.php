...
<?php if (isset($drop_off_locations) && !empty($drop_off_locations)) : ?>
    <div class="redq-drop-off-location rnb-select-wrapper rnb-component-wrapper">
        ...
        <select class="redq-select-boxes dropoff_location rnb-select-box" name="dropoff_location"
                data-placeholder="<?php echo esc_attr($labels['return_loc_placeholder']); ?>">
            ...
            <?php foreach ($drop_off_locations as $key => $value) { ?>
                <option value="<?php echo esc_attr($value['address']); ?>|<?php echo esc_attr($value['title']); ?>|<?php echo esc_attr($value['cost']); ?>"
                        data-dropoff-location-cost="<?php echo esc_attr($value['cost']); ?>"><?php echo esc_attr($value['title']); ?></option>
            <?php } ?>
        </select>
    </div>
<?php endif; ?>