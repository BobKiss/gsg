...
if (!empty($redq_product_inventory))
    $person_info = $product->redq_get_rental_payable_attributes('person', $redq_product_inventory[0]);
...
<?php if (isset($adults) && !empty($adults)) : ?>
    <div class="additional-person additional-person-adult rnb-select-wrapper rnb-component-wrapper">
        ...
        <select class="additional_adults_info redq-select-boxes rnb-select-box" name="additional_adults_info"
                data-placeholder="<?php echo esc_attr($labels['adults_placeholder']); ?>">
            ...
            <?php foreach ($adults as $key => $value) { ?>
                <?php if ($value['person_cost_applicable'] == 'per_day') { ?>
                    <option class="show_adults_cost_if_day"
                            ...
                            data-person_hourly_cost="<?php echo esc_attr($value['person_hourly_cost']); ?>"
                    ...
                    <option class="show_adults_cost_if_time" style="display: none;"
                            value="<?php echo esc_attr($value['person_count']); ?>|<?php echo esc_attr($value['person_cost']); ?>|<?php echo esc_attr($value['person_cost_applicable']); ?>|<?php echo esc_attr($value['person_hourly_cost']); ?>"
                            data-person_cost="<?php echo esc_attr($value['person_cost']); ?>"
                            data-person_hourly_cost="<?php echo esc_attr($value['person_hourly_cost']); ?>"
                            data-person_count="<?php echo esc_attr($value['person_count']); ?>"
                ...
                <?php } else { ?>
                    <option value="<?php echo esc_attr($value['person_count']); ?>|<?php echo esc_attr($value['person_cost']); ?>|<?php echo esc_attr($value['person_cost_applicable']); ?>|<?php echo esc_attr($value['person_hourly_cost']); ?>"
                            data-person_cost="<?php echo esc_attr($value['person_cost']); ?>"
                            data-person_count="<?php echo esc_attr($value['person_count']); ?>"
                            data-applicable="<?php echo esc_attr($value['person_cost_applicable']); ?>">
...
<?php if (isset($childs) && !empty($childs)) : ?>
    <div class="additional-person additional-person-child rnb-select-wrapper rnb-component-wrapper">
        ...
        <select class="additional_childs_info redq-select-boxes rnb-select-box" name="additional_childs_info"
                data-placeholder="<?php echo esc_attr($labels['childs_placeholder']); ?>">
            ...
            <?php foreach ($childs as $key => $value) { ?>
                <?php if ($value['person_cost_applicable'] == 'per_day') { ?>
                    ...
                    <option class="show_childs_cost_if_time" style="display: none;"
                            value="<?php echo esc_attr($value['person_count']); ?>|<?php echo esc_attr($value['person_cost']); ?>|<?php echo esc_attr($value['person_cost_applicable']); ?>|<?php echo esc_attr($value['person_hourly_cost']); ?>"
                            data-person_cost="<?php echo esc_attr($value['person_cost']); ?>"
                            data-person_hourly_cost="<?php echo esc_attr($value['person_hourly_cost']); ?>"
                            data-person_count="<?php echo esc_attr($value['person_count']); ?>"
