...
<div class="price-showing">
    <div class="<?php echo esc_attr($filpbox[1]); ?>">
        ...
        <div class="item-pricing">
            <h5><?php echo get_the_title($inventory); ?></h5>
            ...
            <?php if ($pricing_data['hourly_pricing_type'] === 'hourly_range') : ?>
            <?php $pricing_plans = $pricing_data['hourly_range']; ?>
            <hr>
            <h5><?php echo esc_html__('Hourly pricing plan', 'redq-rental'); ?></h5>
            <div class="rnb-pricing-wrap">
                <?php if( is_array($pricing_plans) && !empty($pricing_plans)){ ?>
                <?php foreach ($pricing_plans as $key => $value) { ?>
