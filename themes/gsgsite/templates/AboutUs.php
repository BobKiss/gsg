  ...
  <div class="aboutUsPageWrapper">
    ...
    <section class="aboutYellow wow slideInLeft">
      ...
      <div class="container">
        ...
        <div class="part bold">
          <p>הצוות שלנו מורכב מאנשי מקצוע מהטובים והמנוסים שיש בשוק, בתחומים שונים ומגוונים- מימון ופיננסים, תכנון והנדסה, משפט, עיצוב ואדריכלות, בארץ ובעולם.</p>
          <p>אנו מזהים פוטנציאל והזדמנויות גם במקומות לא קונבנציונאליים, ומביאים את תפיסת העולם שלנו ואת העיצובים הייחודיים שלנו לכל מקום אליו אנו מגיעים. כל הפרויקטים שלנו, ללא קשר לגודלם, זוכים לטיפול אישי וליווי צמוד של עורך דין, מהנדס ומנהל פרויקט. אשר מובילים את הפרויקט מרגעיו הראשונים ועד למסירתו ללקוח.</p>
        </div>
      </div>
      <div class="col-12 col-md-6">
        <div class="part">
          ...
          <p>אנו לא נרתעים מפרויקטים מורכבים. חילוץ פרויקטים מקשיים, הסרת חסמים, מימון, ופתרון מחלוקות משפטיות, אצלנו זו שיגרה.  אנחנו אלופים בהכנת לימונדה! לוקחים פרויקטים מסובכים משפטית ותכנונית, עם קונפליקטים וחסמים רבים, ומצליחים להפוך את הלימון החמוץ ללימונדה מתוקה ורעננה.
את כל זה אנו מצליחים לעשות בזכות צוות הקומנדו הייחודי שלנו, אשר פיתח מומחיות רבה בפיתוח פרויקטים משלב שינוי/ תכנון התב"ע, דרך פתרון כל החסמים התכנוניים הבירוקרטיים והמשפטיים ועד למסירת המוצר המוגמר והמותאם אישית לכל לקוח.</p>
        </div>
      </div>
    </div>
      </div>
